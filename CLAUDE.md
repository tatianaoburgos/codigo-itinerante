...
Primeiro cliente real em andamento: **LumeHostel** (`clientes/lumehostel/`), com tema próprio (`template/src/styles/temas/lumehostel.css`, cores/fontes do MIV — ver `clientes/lumehostel/marca.md`). Estado: esqueleto com conteúdo `[PROVISORIO]` e fotos placeholder, aguardando briefing (`clientes/lumehostel/PENDENCIAS.md`). Build/preview: `CLIENTE=lumehostel`.
